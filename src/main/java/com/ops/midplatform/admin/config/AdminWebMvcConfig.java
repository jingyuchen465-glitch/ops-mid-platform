...
public class AdminWebMvcConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/share/studio/skills").setViewName("forward:/index.html");
        registry.addViewController("/share/studio/skills/edit").setViewName("forward:/index.html");
        ...
        registry.addViewController("/share/studio/resources").setViewName("forward:/index.html");
        registry.addViewController("/share/studio/resources/edit").setViewName("forward:/index.html");
